...
- Блокирующее модальное объяснение ошибок в симуляторе и итоговый экран сценария с `score / max_score` и перепрохождением
...
- Расширенный раздел `Для пользователей` с объяснением механики deepfake, quishing, spear phishing, fake apps и многошаговых схем с кодами
...
- модуль выбора действия с подсказками, последствиями и блокирующим разбором ошибок
