...
Проект закрывает базовые требования `TZ.txt`:
...
- Отдельный вход администратора по логину `Admin`
...
- Админка для пользователей и сценариев
- Публикация сценариев по статусам: `draft`, `scheduled`, `live`, `disabled`
