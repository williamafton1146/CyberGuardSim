    ...
    <RequireAuth>
      <div className="shell space-y-10 py-12">
        <SectionTitle
          ...
          description="Пользователь проходит цепочку решений, получает последствия ошибки и закрепляет корректный паттерн поведения вместо сухого теста."
        />
            ...
            {session ? (
              ...
              <div className="glass-card p-8">
                ...
                <p className="body-copy mt-4 max-w-xl text-sm">
                  Для демо уже доступна полноценная офисная ветка на 4 шага. После запуска справа появится текущая угроза,
                  варианты действий, шкала HP и обратная связь по каждому решению.
                </p>
              </div>
            )}
          </div>
